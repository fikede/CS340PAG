...
namespace _340GUI
{
    public partial class PricePolicy : Form
    {
        ...
        {
            label_CPDWarning.Visible = show;
            label_FAGDWarning.Visible = show;
            label_PAWarning.Visible = show;
            label_SMWarning.Visible = show;
            label_AGFPDWarning.Visible = show;
            label_dateWarning.Visible = show;
            label_MAADWarning.Visible = show;
            label_SBPWarning.Visible = show;
        }
